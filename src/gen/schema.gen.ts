...
export interface paths {
  ...
  "/teammates/{teammate_id}/private_inboxes": {
     ...
     *     Required scope: `inboxes:read`
     */
    get: operations["list-teammate-private-inboxes"];
    put?: never;
    /**
     ...
     *     Required scope: `inboxes:write`
     */
    post: operations["create-teammate-private-inbox"];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
  ...
  "/teams/{team_id}/views": {
     ...
     */
    get: operations["list-team-views"];
    put?: never;
    /**
     * Create team view
     ...
     */
    post: operations["create-team-view"];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
  ...
  "/views/{view_id}/teammates": {
     ...
     *     Required scope: `views:write`
     */
    post: operations["add-view-teammates"];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
...
export interface components {
  schemas: {
    ...
    AnalyticsMetricId:
      ...
      | "num_active_teammates"
      | "num_archived_segments"
      | "num_archived_segments_with_reply"
      | "num_assigned_segments"
      | "num_csat_survey_response"
      | "num_messages_received"
      | "num_messages_sent"
      | "num_new_tasks"
      | "num_non_replies_sent"
      | "num_replies_sent"
      | "num_segments_with_outbounds"
      | "num_segments_with_tag_changes"
      | "num_sla_breach"
      | "num_tags_added"
      | "num_tags_removed"
      | "num_touched_segments"
      | "pct_csat_survey_satisfaction"
      | "pct_messages_with_message_templates"
     ...
     * @enum {string}
     */
    AnalyticsScalarType: "number" | "percentage" | "string" | "duration" | "resource";
    ...
    listOfViews: {
      ...
      content: {
        "application/json": {
          ...
          _results?: components["schemas"]["SharedViewResponse"][];
        };
      };
    };
...
export interface operations {
  ...
  "create-inbox": {
    ...
    responses: {
      201: components["responses"]["inbox"];
    };
  };
  ...
  "list-team-views": {
    ...
    requestBody?: never;
    responses: {
      200: components["responses"]["listOfViews"];
    };
  };
  "create-team-view": {
    parameters: {
